...
//Fim do upload do arquivo.
  ...
  $novaCategoria = "INSERT INTO `categorias` (`id`,`nomeCat`,`imgCat`) VALUES ('','$nomeCat','$file_name[2]');";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"enctype="multipart/form-data">
    ...
    <div class="col-12 mt-3">
		  <label for="nomeModelo" class="form-label">Categoria</label>
    ...
    <table class="table">
	  ...
	  <?php $i = 1; if(mysqli_num_rows($resultList)>0){
        ...
        <tr>
            ...
            <td><img style="border: 1px solid #ddd; border-radius: 4px; padding: 5px; width: 150px;" src="uploads/categorias/<?php echo $rowList['imgCat']; ?>"></td>
            <td><button type="submit" class="btn btn-primary">EDITAR</button>
            <a class="btn btn-danger" href="del_cat.php?id=<?php echo $rowList ['id']; ?>"><button class="btn btn-danger">EXCLUIR</button></a></td>
        </tr>
        <?php
